...
echo "=== Nano Code Agent End-to-End Test (Quick) ==="

# Clean previous build (skipped for quick test)
# echo "1. Cleaning previous build..."
# cargo clean

# Build the project (skipped for quick test)
# echo "2. Building project..."
# cargo build

# Run unit tests (skipped for quick test)
